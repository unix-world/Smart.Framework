<?php
// [LIB - Smart.Framework / Symmetric Encrypt/Decrypt Crypto]
...
//======================================================
// Smart-Framework - Symmetric Crypto Ciphers # r.20260114
// 		* encrypt / decrypt:
// 			- ThreeFish 1024-bit cipher (CBC) built-in ; requires PHP GMP extension
// 			- TwoFish    256-bit cipher (CBC) built-in
// 			- BlowFish   448-bit cipher (CBC) built-in
// 			- OpenSSL various ciphers:
// 				- BlowFish    (CFB) using OpenSSL
// 				- AES256      (CBC/CFB/OFB) using OpenSSL
// 				- Camellia256 (CBC/CFB/OFB) using OpenSSL
// 				- Idea        (CBC/CFB/OFB) using OpenSSL
// 		* shad:
// 			- DhKx ; requires PHP GMP extension
//======================================================
...
final class SmartCryptoCiphersThreefishCBC {
	...
	// License: BSD
	// code was ported to PHP on 2023-12-02 by unixman: Radu Ovidiu Ilies <iradu@unix-world.org>
...
//
// Modified from by unixman (iradu@unix-world.org), contains fixes and optimizations
// (c) 2023-present unix-world.org
//--

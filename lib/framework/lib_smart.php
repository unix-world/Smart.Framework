...
final class Smart {
	...
	public static function striptags(?string $yhtmlcode, ?string $ynewline='yes') {
		...
		$yhtmlcode = (string) str_ireplace((array)array_keys((array)$arr_replacements), (array)array_values((array)$arr_replacements), (string)$yhtmlcode); // must be insensitive replace ... by example &Prime; can be also &prime;

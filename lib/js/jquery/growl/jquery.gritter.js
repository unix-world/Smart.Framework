...
(function($){
	...
	* Currently supports only mode = toastr
	* @see Gritter#translateCssClasses();
	*/
	$.gritter.translateCssClasses = function(mode, class_name) {
		...
		} else if(mode === 'gritter') {
			// leave as they are, will be validated below
		} else {
			class_name = '';
		}
		if(class_name.indexOf('gritter-') !== 0) { // fix, allow just 'gritter-' prefixed css classes
			class_name = 'gritter-neutral'; // default class
		}

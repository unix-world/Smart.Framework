 ...
 *  All rights reserved.
 * (c) 2021 unix-world.org (fix code for better readability, by unixman)
 * ========================================================== */
	...
	ContainerGroup.prototype = {
		...
		setupDelayTimer: function () {
			...
			if(!this.delayMet) {
				...
				this._mouseDelayTimer = setTimeout(function(){ that.delayMet = true; }, this.options.delay);
			}
		},
		scroll: function(e) {
			this.clearDimensions();

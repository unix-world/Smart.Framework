...
(function ($) {
	...
	var tagAllowEmpty = ["body", "th", "td", "tbody", "section", "div", "span", "ul", "ol", "li", "a", "pre", "legend", "nav", "blockquote", "select", "textarea", "option", "optgroup", "label", "canvas", "iframe"];
	var tagStartAddNewLineBefore = ["script", "table", "thead", "tbody", "tfoot", "tr", "th", "td", "div", "section", "header", "main", "footer", "nav", "ul", "ol", "li", "option", "optgroup", "hr", "pre"]; // unixman
	var tagStartAddNewLineAfter = [ "picture", "video", "audio", "source", "link" ]; // unixman
	var tagEndAddNewLineBefore = [ "script", "style", "picture", "video", "audio", "pre", "code" ]; // unixman
	var tagEndAddNewLineAfter   = ["script", "style", "table", "tr", "th", "td", "div", "nav", "ul", "ol", "li", "option", "optgroup", "picture", "video", "audio"]; // unixman
	...
	var tagAttributes = [
			...
			//--
			"img", 		["id", "class", "style", "src", "data-src", "align", "rel", "alt", "title", "border", "usemap", "onclick", "ondblclick", "ontouchstart", "ontouchend", "onmouseover", "onmouseout"], // "width", "height" are available by option (by default it make all images responsive: max-width:100%)
			"picture" 	["id", "class", "style", "width", "height"],
			"video", 	["id", "class", "style", "src", "controls", "autoplay", "loop", "preload", "poster", "muted", "width", "height"],
			"audio", 	["id", "class", "style", "src", "controls", "autoplay", "loop", "preload", "muted"],
			"source", 	["id", "class", "style", "src", "srcset", "data-src", "type", "media"],
			"track", 	["src", "srclang", "kind", "label", "default"],
			//--
			"canvas", 	["id", "class", "style", "width", "height"],
			//--
			"table", 	["id", "class", "style", "align", "title", "width", "height", "cellpadding", "cellspacing", "border", "bgcolor", "onclick", "ontouchstart", "ontouchend"],
			"tr",		["id", "class", "style", "align", "title", "valign", "bgcolor", "onclick", "ondblclick", "ontouchstart", "ontouchend", "onmouseover", "onmouseout"],
			"th", 		["id", "class", "style", "align", "title", "valign", "width", "height", "colspan", "rowspan", "bgcolor", "onclick", "ondblclick", "ontouchstart", "ontouchend", "onmouseover", "onmouseout"],
			"td", 		["id", "class", "style", "align", "title", "valign", "width", "height", "colspan", "rowspan", "bgcolor", "onclick", "ondblclick", "ontouchstart", "ontouchend", "onmouseover", "onmouseout"],
			//--
			"i", 		["class"], // used for icons
			...
			"pre", 		["id", "class", "style", "onclick", "ondblclick", "ontouchstart", "ontouchend", "onmouseover", "onmouseout"],
			//--
			"form", 	["id", "class", "style", "name", "title", "action", "target", "method", "enctype", "autocomplete", "rel", "novalidate", "onsubmit", "onreset"], // accept
			"button", 	["id", "class", "style", "name", "title", "type", "value", "disabled", "formaction", "formtarget", "onclick", "ondblclick", "ontouchstart", "ontouchend", "onmouseover", "onmouseout", "onsubmit"],
			"input", 	["id", "class", "style", "name", "title", "align", "type", "src", "value", "width", "height", "size", "maxlength", "checked", "multiple", "min", "max", "step", "disabled", "readonly", "required", "autocomplete", "placeholder", "list", "formaction", "formtarget", "alt", "onclick", "ondblclick", "ontouchstart", "ontouchend", "onmouseover", "onmouseout", "onchange", "onblur", "oninput", "onreset", "onselect", "onsubmit"], // accept, accesskey, tabindex
			"textarea", ["id", "class", "style", "name", "title", "maxlength", "rows", "cols", "wrap", "disabled", "readonly", "required", "placeholder", "onclick", "ondblclick", "ontouchstart", "ontouchend", "onmouseover", "onmouseout", "onchange", "onblur", "oninput", "onreset", "onselect", "onsubmit"], // accesskey, tabindex
			"select", 	["id", "class", "style", "name", "title", "size", "multiple", "disabled", "required", "onclick", "ondblclick", "ontouchstart", "ontouchend", "onmouseover", "onmouseout", "onchange", "onblur", "onreset", "onselect", "onsubmit"],

...
var SmartJS_BrowserUtils = new function() { // START CLASS
	...
	this.param_Time_Notification_OK = 1000; 		// time in microseconds to display growl when OK
	this.param_Time_Notification_ERR = 3000; 		// time in microseconds to display growl when ERR
	this.param_Time_Delay_Redirect = 1500; 			// time in microseconds used on page redirects

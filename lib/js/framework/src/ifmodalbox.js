...
const smartJ$ModalBox = new class{constructor(){ // STATIC CLASS
	...
	const _Option$ = ((typeof(smartJ$Options) != 'undefined') && smartJ$Options && $.isPlainObject(smartJ$Options) && (smartJ$Options.ModalBox != undefined) && $.isPlainObject(smartJ$Options.ModalBox)) ? smartJ$Options.ModalBox : null;
...
//	const _BwUtils$ = smartJ$Browser; // needed for scanner only ; because the smart box loads before it it throws referencing the class here in ES6 !
	 ...
	 * @memberof smartJ$ModalBox
	 */
	const param_LoaderBlank = (_Option$ && (typeof(_Option$.LoaderBlank) == 'string') && _Option$.LoaderBlank) ? _Utils$.stringTrim(_Option$.LoaderBlank) : 'lib/js/framework/blank.html';

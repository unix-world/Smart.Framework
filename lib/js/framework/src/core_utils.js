...
const smartJ$Utils = new class{constructor(){ // STATIC CLASS
	 ...
	 * const tpl = '<div onclick="let question=\'[###QUESTION|js|html###]\'; alert(question);">[###TITLE|html###]</div>'; // the TPL
	...
	const renderMarkersTpl = function(template, arrobj, isEncoded=false, revertSyntax=false) { // ES6
		//--
		if((typeof(template) === 'string') && (typeof(arrobj) === 'object')) { // syntax: r.20210412
			//--
			if(isEncoded === true) {

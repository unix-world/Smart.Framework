...
# PAK: Combine all required App Core.Plugins CSS scripts from lib/core/plugins/css/app.css into one package CSS file: lib/core/plugins/css/app.pak.css # r.20221119
...
echo "/* Included Files: markdown.css ; navpager.css ; captcha.css ; email.css ; v-timeline/style.css ; v-timeline/style-responsive.css ; txt-columns/style.css ; txt-columns/style-responsive.css # */" >> ${THE_FILE}
echo "" >> ${THE_FILE}
echo "/* ### DO NOT EDIT THIS FILE AS IT WILL BE OVERWRITTEN EACH TIME THE INCLUDED SCRIPTS WILL CHANGE !!! ### */" >> ${THE_FILE}
echo "" >> ${THE_FILE}

echo "/* ===== core/plugins/markdown.css */" >> ${THE_FILE}
cat ../lib/core/plugins/css/markdown.css >> ${THE_FILE}
echo "" >> ${THE_FILE}
...
echo "/* ===== core/plugins/captcha.css */" >> ${THE_FILE}
cat ../lib/core/plugins/css/captcha.css >> ${THE_FILE}
echo "" >> ${THE_FILE}

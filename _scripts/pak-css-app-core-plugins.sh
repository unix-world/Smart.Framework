...
# PAK: Combine all required App Core.Plugins CSS scripts from lib/core/plugins/css/app.css into one package CSS file: lib/core/plugins/css/app.pak.css # r.20221228
...
echo "/* Included Files: navpager.css ; captcha.css ; email.css ; v-timeline/style.css ; v-timeline/style-responsive.css ; txt-columns/style.css ; txt-columns/style-responsive.css # */" >> ${THE_FILE}
echo "" >> ${THE_FILE}

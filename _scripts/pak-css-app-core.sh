...
echo "/* Included Files: custom.css ; notifications.css ; notifications-icons.css ; tpl-highlight.css # */" >> ${THE_FILE}
echo "" >> ${THE_FILE}
...
echo "/* ===== core/tpl-highlight.css */" >> ${THE_FILE}
cat ../lib/core/css/tpl-highlight.css >> ${THE_FILE}
echo "" >> ${THE_FILE}

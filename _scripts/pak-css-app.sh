...
# PAK: Combine all required App CSS scripts from lib/css/app.css into one package CSS file: lib/css/app.pak.css # r.20221119
...
echo "/* Included Files: toolkit/ux-toolkit.css ; toolkit/ux-toolkit-responsive.css # */" >> ${THE_FILE}
echo "" >> ${THE_FILE}

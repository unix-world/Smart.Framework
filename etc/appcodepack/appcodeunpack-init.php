...
const APP_AUTH_ADMIN_ENCRYPTED_SECKEY = ''; // To generate a user encrypted security key for this config, use \SmartAuth::encrypt_sensitive_data($plainTextKey, \SmartHashCrypto::password($plainTextPassword, $userName))

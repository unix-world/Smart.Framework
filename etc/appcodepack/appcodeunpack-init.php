<?php
// [@[#[!NO-STRIP!]#]@]
// [AppCodeUnpack / INIT] v.20220928 s.20220928.1034
...
//const SMART_FRAMEWORK_SRVPROXY_SERVER_IP = 			'HTTP_X_FORWARDED_IP'; 						// used to get the real IP of the proxy server where apache runs behind ; can be set to get a value from headers as 'HTTP_X_FORWARDED_IP' or can be set to a static value like '127.0.0.1'
//const SMART_FRAMEWORK_SRVPROXY_SERVER_DOMAIN =		'HTTP_X_FORWARDED_DOMAIN'; 					// used to get the real domain name or IP of the proxy server where apache runs behind ; can be set to get a value from headers as 'HTTP_X_FORWARDED_DOMAIN' or can be set to a static value like 'www.yourdomain.ext' or '127.0.0.1'

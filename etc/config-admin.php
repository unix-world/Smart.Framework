...
define('APP_AUTH_ADMIN_PASSWORD', 'bf448.v2!M_dLgKkJbziWnUaEe4ZAFb36AAOKKNpzXKQYlawCT7XZZptCPI2oos03TdpCmUk6UTAafJWVTs2Wc-zdChpOilJpuV0ZXNeG'); // default admins auth complex pass is: `The1pas!` ; complex passwords req. min 8 characters, max 88 ; see the comment above about complexity characters in passwords
// To generate an encrypted password for this config, use: \SmartAuth::encrypt_privkey($plainTextPassword, $userName)
...
define('APP_AUTH_PRIVILEGES', '<superadmin>,<admin>'); // sample: '<custom-priv-a>,<custom-priv-b>,<custom-priv-z>' // a privilege key must have 3..16 characters and can contain only: a-z -

...
//define('SMART_FRAMEWORK_CUSTOM_ERR_PAGES', 'modules/mod-samples/error-pages/'); // `` or custom path to error pages: 400.php, 401.php, 403.php, 404.php, 410.php, 429.php, 500.php, 502.php, 503.php, 504.php ; if this is enabled will serve customized responses for 4xx/5xx HTTP Status Codes ; you can customize any of 4xx/5xx or all ...
//---------------------------------------

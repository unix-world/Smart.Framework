...
define('SMART_APP_MODULES_RELEASE', 'm.sf.2023-01-29'); // this can be used for tracking changes to custom app modules
//--

//-- checks the minimum version of the Smart.Framework to run on # v.20230129
define('SMART_APP_MODULES_MIN_FRAMEWORK_VER', 'v.8.7.r.2023.01.29'); // this must be used to validate the required minimum framework version

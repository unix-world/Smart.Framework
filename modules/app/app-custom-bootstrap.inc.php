...
define('SMART_APP_MODULES_RELEASE', 'm.sf.2021-03-20'); // this can be used for tracking changes to custom app modules
//--

//-- checks the minimum version of the Smart.Framework to run on
define('SMART_APP_MODULES_MIN_FRAMEWORK_VER', 'v.7.2.1.r.2021.03.20'); // this must be used to validate the required minimum framework version

...
define('SMART_APP_MODULES_RELEASE', 'm.sf.2024-11-23'); // this can be used for tracking changes to custom app modules
//--

//-- checks the minimum version of the Smart.Framework to run on # v.20241123
define('SMART_APP_MODULES_MIN_FRAMEWORK_VER', 'v.8.7.r.2024.11.23'); // this must be used to validate the required minimum framework version

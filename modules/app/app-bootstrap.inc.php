...
define('SMART_APP_MODULES_RELEASE', 'm.sf.2025-12-10.2358'); // this can be used for tracking changes to custom app modules
//--

//-- checks the minimum version of the Smart.Framework to run on # v.20251210
define('SMART_APP_MODULES_MIN_FRAMEWORK_VER', 'v.8.7.r.2025.12.10'); // this must be used to validate the required minimum framework version

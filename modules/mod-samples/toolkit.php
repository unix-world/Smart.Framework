...
class SmartAppIndexController extends SmartAbstractAppController {
	...
	public function Run() {
		...
		$this->PageViewSetVars([
			...
			'main'	=> (string) '<h1 style="font-size:3em !important; display: inline !important;">Smart.Framework / UI Toolkit Plugins - Demo</h1><h2 font-size:2.5em !important; display: inline !important;><span style="color:#778899; font-weight:normal;"><span style="cursor:help;" title="UX Toolkit is built into the Smart.Framework and provided as the default UI Toolkit. You can use it or not ... If you prefer you can use other UI Toolkits such as: UiKit, Bootstrap, jQueryUI or any other you may like !"><i>UX Toolkit</i> (built-in)</span> - a very lightweight <span style="cursor:help;" title="This size is calculated when the CSS is minified ...">(~32KB)</span>, CSS only, responsive front-end Toolkit<br>for web interfaces &nbsp; <span><i><sup style="color:#DCDCDC;">inspired from Pure.css and W3.css UI Toolkits</sup></i></span></span></h2><hr>'.trim((string)$fcontent).'<hr><br><br>'
		]);
		//--
		$fcontent = ''; // free mem
		//--

<?php
// Controller: Samples/TaskSample3
// Route: task.php?/page/samples.task-sample-3 (task.php?page=samples.task-sample-3)
...
final class SmartAppTaskController extends \SmartModExtLib\AuthAdmins\AbstractTaskController {
	...
	public function Run() {
		...
		//--
		$this->sficon = 'cogs';
		$this->err = 'Task #3 NOT Completed (this is just a sample ...)';
		//--

...
-- START :: SQLite: PageBuilder r.20210307 #
...
INSERT INTO `_smartframework_metadata` (`id`, `description`) VALUES ('version@page-builder', 'v.2021.03.07');

-- Table Structure: Page-Builder #

CREATE TABLE 'page_builder' ( 								-- Web - Page Builder v.2021.03.07
...
CREATE TABLE 'page_translations' ( 							-- Web - Page (Builder) Translations v.2021.03.07
